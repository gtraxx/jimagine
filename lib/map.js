...
var jm_map = (function ($, undefined) {
     ...
     * @param debug
     */
    function getLatLng(id,setting,debug){
        if(jQuery().gmap3){
            if($(id).length != 0){
                tabconfig = setConfig(setting);
                if(debug!=false){
     ...
     * @param debug
     */
    function getAdressPosition(id,tabconfig,debug){
        if(jQuery().gmap3){
            if($(id).length != 0){
                tabconfig = setConfig(setting);
                if(typeof tabconfig['content'] !== "undefined"){
    ...
    return {
         ...
         */
        latLng:function (id,tabconfig,debug) {
            getLatLng(id,tabconfig,debug);
        },
        /**
         * @exemple:
         *  var confcontent = '$("#title").val();
         ...
         */
        adressPosition:function(id,tabconfig,debug){
            getAdressPosition(id,tabconfig,debug);
        },
        /**
