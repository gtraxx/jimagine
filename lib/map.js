...
var jm_map = (function ($, undefined) {
    ...
    function setConfig(setting){
        ...
        if(typeof setting['adress'] !== "undefined"){
            setting['adress'];
        }
     ...
     * @param direction
     */
    //function getDirection(elem,adress,input,container,direction){
    function getDirection(id,setting,debug){
        setting = setConfig(setting);
        var eventclick,adress,inputext;
        if(typeof setting['adress'] !== "undefined"){
    ...
    return {
         ...
         *  var confcontent = '$("#title").val();
         var tabconfig = {
			adress: "Place Saint Lambert, Liège",
			latitude : '#lat',
			longitude : '#lng',
			zoom : 14
		};
         jm_map.adressPosition('#my_map',tabconfig,false);
         */
        adressPosition:function(id,setting,debug){
            getAdressPosition(id,setting,debug);
        },
        /**
         ...
         * @param direction
         */
        getDirection:function(elem,adress,input,container,direction){
            getDirection(elem,adress,input,container,direction);
        },
        /**
         * @exemple :
         * if($("#mymap").length !=0){
